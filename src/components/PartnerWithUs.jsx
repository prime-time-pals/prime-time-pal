...
function PartnerWithUs() {
    return (
        <div className="relative my-[100px] m-10 rounded-xl text-white bg-gradient-to-r from-[#0070FF] to-[#0070FF] h-auto font-saeada-thin lg:flex">
            <img src={whitePattern} alt="backgroundImg" className="opacity-20 w-full h-full object-cover top-0 absolute mix-blend-overlay " />
            <img className="rounded-t-lg md:rounded-t-none md:rounded-tl-xl md:rounded-bl-xl w-full lg:w-[560px]" src={partnerImage} alt="Photo of old folks holding hands" />
