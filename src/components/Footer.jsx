            ...
            <div className="md:flex md:gap-10">
                ...
                <div className="md:flex-1 my-8 md:mt-0 md:flex md:flex-col justify-center tracking-widest">
                    ...
                    <h3 className="my-2 font-saeada-regular tracking-widest text-[20px] text-[#FF4D0A]">Quick Links</h3>
                        <li className="my-4"><Link className="font-saeada-regular text-[16px] text-[#5D5D5D]" to="/">Home</Link></li>
                        <li className="my-4"><Link className="font-saeada-regular text-[16px] text-[#5D5D5D]" to="/about-us">About Us</Link></li>
                        <li className="my-4"><Link className="font-saeada-regular text-[16px] text-[#5D5D5D]" to="/activities">Activities</Link></li>
                        <li className="my-4"><Link className="font-saeada-regular text-[16px] text-[#5D5D5D]" to="/partner">Partner With Us</Link></li>
                        <li className="my-4"><Link className="font-saeada-regular text-[16px] text-[#5D5D5D]" to="/contact">Contact Us</Link></li>
                    </ul>
                </div>
